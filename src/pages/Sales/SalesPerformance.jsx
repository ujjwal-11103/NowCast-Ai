            ...
            <main className="max-w-[1600px] mx-auto space-y-8 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both">
                ...
                <div className="mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <div className="flex justify-between items-end mb-6">
                        <div>
                            <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight mb-2">Sales Performance</h1>
                            <p className="text-slate-500 font-medium text-lg">Track KPIs, regional performance, and top customers.</p>
                        </div>
