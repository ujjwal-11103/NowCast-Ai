...
const generateSOSData = () => {
    // Simulating Source of Sales Breakdown
    return {
        data: [{
            labels: ["Base Volume", "Media Incremental", "Trade Incremental", "Price Effect", "Competitor Impact"],
            values: [55, 18, 12, 10, 5],
            type: "pie",
            hole: 0.6, // Thinner donut
            sort: false,
            marker: {
                // Premium color palette
                colors: ["#1e293b", "#3b82f6", "#8b5cf6", "#10b981", "#f43f5e"]
                // Slate-800, Blue-500, Violet-500, Emerald-500, Rose-500
            },
            textinfo: "percent", // clean look
            textposition: "inside",
...
const MarketMixModeling = () => {
    ...
    const [sosGraphData, setSosGraphData] = useState(null);
    ...
    useEffect(() => {
        ...
        setSosGraphData(generateSOSData());
    ...
    return (
        <div className="flex-1 bg-slate-50 relative min-h-screen p-8 font-sans overflow-x-hidden text-slate-900">
            ...
            <div className="max-w-[1600px] mx-auto space-y-8 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-both">
                ...
                <div>
                    {alertVisible && (
                        <div className="bg-accent text-white p-4 rounded-xl flex justify-between items-center mb-6 shadow-md hover:shadow-lg transition-all">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            <button
                                ...
                                className="flex items-center gap-2 bg-primary text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-blue-900 transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
                            >
                            ...
                            {!runSimulator ? (
                                <button
                                    ...
                                    className="flex items-center gap-2 bg-accent text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-orange-600 transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
                                >
                                ...
                                <div className="flex items-center gap-2 bg-white rounded-full px-4 py-1.5 border border-orange-200 shadow-sm">
                                    ...
                                    >
                                        <div className="bg-accent rounded-full p-0.5"><div className="bg-white w-1.5 h-1.5 rounded-full"></div></div>
                                        Stop
                                    </button>
                                </div>
                            )}
                                    ...
                                    <Plot
                                        ...
                                        layout={{
                                            ...
                                            legend: {
                                                ...
                                                xanchor: 'left',
                                                y: 0.5,
                                                font: { size: 10, family: 'Montserrat, sans-serif', color: '#64748b' }
                                            },
                                            paper_bgcolor: 'rgba(0,0,0,0)',
                                            plot_bgcolor: 'rgba(0,0,0,0)',
                                            font: { family: 'Montserrat, sans-serif' }
